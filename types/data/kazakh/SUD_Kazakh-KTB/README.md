# **SUD_Kazakh-KTB**: SUD treebank conversion for the corpus UD_Kazakh-KTB version 2.17
This treebank was automatically generated from the UD treebank:
[UD_Kazakh-KTB](https://github.com/UniversalDependencies/UD_Kazakh-KTB/releases/tag/r2.17).

See [SUD data page](https://surfacesyntacticud.org/data/) for more details about the conversion process.

The rest of this file is a copy of the original README associated to **UD_Kazakh-KTB** and therefore refers to UD.
