# **SUD_Faroese-OFT**: SUD treebank conversion for the corpus UD_Faroese-OFT version 2.17
This treebank was automatically generated from the UD treebank:
[UD_Faroese-OFT](https://github.com/UniversalDependencies/UD_Faroese-OFT/releases/tag/r2.17).

See [SUD data page](https://surfacesyntacticud.org/data/) for more details about the conversion process.

The rest of this file is a copy of the original README associated to **UD_Faroese-OFT** and therefore refers to UD.
