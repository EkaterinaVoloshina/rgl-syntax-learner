# **SUD_Macedonian-MTB**: SUD treebank conversion for the corpus UD_Macedonian-MTB version 2.17
This treebank was automatically generated from the UD treebank:
[UD_Macedonian-MTB](https://github.com/UniversalDependencies/UD_Macedonian-MTB/releases/tag/r2.17).

See [SUD data page](https://surfacesyntacticud.org/data/) for more details about the conversion process.

The rest of this file is a copy of the original README associated to **UD_Macedonian-MTB** and therefore refers to UD.
