...
--     Wiktionary        UD                         GF record fld.  GF param constr.  GF param type  
 ...
 -- ,tag "infinitive"      []                           "inf"           "Inf"             "NonFinite"
  ,tag "infinitive"      [("VerbForm","Inf")]        "infinitive"     "Infinitive"      "NonFinite"
  ...
  ,tag "converb"         [("VerbForm", "Conv")]       "converb"       "Converb"         ""
 ...
 -- ,tag "aorist"          [("Tense","Past"), ("Aspect", "Imp")]           "aorist"        "Aorist"          "Tense"
  ,tag "imperfect"       [("Tense","Imp")]            "imperfect"     "Imperfect"       "Tense"
  ,tag "perfect"         [("Aspect", "Perf")]         "perfect"       "Perfect"         "Aspect"
  ...
  ,tag "imperfective"    [("Aspect","Imp")]           "imperfective"  "Imperfective"    "Aspect"
  ...
  ,tag "subjunctive"     [("Mood", "Sub")]           "subjunctive"   "Subj"            "Mood"
  ,tag "optative"        [("Mood", "Opt")]            "optative"      "Opt"             "Mood"
  ...
  ,tag "future-perfect"  []                          "future_perf"   "FuturePerfect"   "Tense"
  ,tag "imperfective"    [("Aspect","Imp")]           "imperf"        "Imperf"          "Aspect"
  ,tag "perfective"      [("Aspect","Perf")]          "perfect"          "Perfect"            "Aspect"
  ,tag "continuative"    []                           "cont"          "Cont"            "Aspect"
  ...
  ,tag "singular"        [("Number[psor]","Sing")]    "singular"      "SgPoss"          "NumberPoss"
  ,tag "plural"          [("Number[psor]","Plur")]    "plural"        "PlPoss"              "NumberPoss"
  ,tag "dual"            [("Number[psor]","Dual")]    "dual"          "DlPoss"              "NumberPoss"
  ...
  ,tag "first-person"    [("Person[psor]","1")]       "first_person"  "P1Poss"          "PersonPoss"
  ,tag "second-person"   [("Person[psor]","2")]       "second_person" "P2Poss"          "PersonPoss"
  ,tag "third-person"    [("Person[psor]","3")]       "third_person"  "P3Poss"          "PersonPoss"
  ,tag "fourth-person"   [("Person[psor]","4")]       "fourth_person" "P4Poss"          "PersonPoss"
  ,tag "count-form"      [("Number","Count")]         "count_form"    "Count"           "CountForm"
  ,tag ""                [("Number","Sing")]          "gsg"           "GSg"             "GenNum"
  ,tag ""                [("Number","Plur")]          "gpl"           "GPl"             "GenNum"
  ,tag ""                [("Number","Sing")]          "asg"           "ASg"             "AForm"
  ,tag ""                [("Number","Plur")]          "apl"           "APl"             "AForm"
  ,tag ""                notInCorpus                  ""              "AdvMod"          "NRelType"
  ,tag ""                notInCorpus                  ""              "AdjMod"          "NRelType"
  ,tag ""                notInCorpus                  ""              "Pref"            "NRelType"
  ,tag ""                notInCorpus                  "rel"           ""                ""
  ,tag ""                notInCorpus                  "adverb"        ""                ""
  ,tag "informal"        [("Polite","Infm")]          "informal"      "Informal"        "Formality"
  ...
  ,tag "passive"         [("Voice","Pass")]            "passive"     "Passive"       "Voice"
  ,tag ""                notInCorpus                  "c2"            ""                ""
  ,tag ""                notInCorpus                  "c3"            ""                ""
  ,tag ""                notInCorpus                  ""              "NoMutation"      "Mutation"
  ,tag ""                notInCorpus                  ""              "Lenited"         "Mutation"
  --,tag ""                notInCorpus                  "noAspect"      "noAspect"        "Aspect"
  --,tag ""                [("Aspect", "Hab")]                           "progressive"    "Progressive"    "Aspect"
  ,tag ""                [("Polarity", "Pos")]       "pos"               "Pos"          "Polarity"
   ,tag ""                [("Polarity", "Neg")]       "neg"               "Neg"          "Polarity"
  ]
  where
